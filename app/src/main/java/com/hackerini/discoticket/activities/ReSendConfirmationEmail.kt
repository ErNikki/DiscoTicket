...
class ReSendConfirmationEmail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_re_send_confirmation_email)
        email = findViewById(R.id.editTextReSendConfEmail)

        val button = findViewById<Button>(R.id.confEmailButton)
